...
class image_processing():
    ...
    def create_root(self):
        ...
        self.radiobutton_widget6 = Radiobutton(self.labelframe_widget1, text="daptive Gaussian", variable=self.v1, value=6)
        ...
        self.radiobutton_widget19 = Radiobutton(self.labelframe_widget3, text="Openning", variable=self.v3, value=19)
